<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="" prop="authorId">
        <el-input
      ...
      <el-form-item label="" prop="editeTime">
        <el-date-picker clearable
          v-model="queryParams.editeTime"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="" prop="belongsTo">
        <el-input
    ...
    <el-table v-loading="loading" :data="answerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="authorId" />
      <el-table-column label="${comment}" align="center" prop="details" />
      <el-table-column label="" align="center" prop="imgUrl" />
      <el-table-column label="" align="center" prop="likes" />
      <el-table-column label="" align="center" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="" align="center" prop="editeTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.editeTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="" align="center" prop="belongsTo" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="" prop="authorId">
          <el-input v-model="form.authorId" placeholder="请输入" />
        </el-form-item>
        ...
        <el-form-item label="" prop="likes">
          <el-input v-model="form.likes" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="" prop="editeTime">
          <el-date-picker clearable
            v-model="form.editeTime"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="请选择">
          </el-date-picker>
        ...
        <el-form-item label="" prop="belongsTo">
          <el-input v-model="form.belongsTo" placeholder="请输入" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除回答管理编号为"' + ids + '"的数据项？').then(function() {
