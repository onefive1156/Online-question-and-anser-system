<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bulletinList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="通知管理" align="center" prop="id" />
      <el-table-column label="通知详情" align="center" prop="details" />
...
<script>
import { listBulletin, getBulletin, delBulletin, addBulletin, updateBulletin } from "@/api/system/bulletin";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/bulletin/export', {
        ...this.queryParams
