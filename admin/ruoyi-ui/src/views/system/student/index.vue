<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="grade" />
      <el-table-column label="" align="center" prop="major" />
      <el-table-column label="" align="center" prop="age" />
      <el-table-column label="" align="center" prop="sex" />
      <el-table-column label="" align="center" prop="introduce" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="" prop="grade">
          <el-input v-model="form.grade" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="" prop="major">
          <el-input v-model="form.major" placeholder="请输入" />
        </el-form-item>
